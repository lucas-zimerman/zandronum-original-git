...
#include "common/rendering/hwrenderer/data/buffers.h"
#include "gl/system/gl_system.h"  // This includes OpenGL headers (GLsync, GLenum, etc.)
...
public:
	...
	void BindRange(HardwareRenderer::FRenderState* state, size_t start, size_t length);
	void BindBase();
};
