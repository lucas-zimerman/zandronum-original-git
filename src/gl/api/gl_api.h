...
__EXTERN PFNGLBUFFERSTORAGEPROC glBufferStorage;
...
// Additional OpenGL extension functions needed by new renderer
__EXTERN PFNGLCOPYBUFFERSUBDATAPROC glCopyBufferSubData;
__EXTERN PFNGLBINDBUFFERRANGEPROC glBindBufferRange;
__EXTERN PFNGLBINDBUFFERBASEPROC glBindBufferBase;
__EXTERN PFNGLFENCESYNCPROC glFenceSync;
__EXTERN PFNGLDELETESYNCPROC glDeleteSync;
__EXTERN PFNGLCLIENTWAITSYNCPROC glClientWaitSync;
__EXTERN PFNGLDRAWBUFFERSPROC glDrawBuffers;
__EXTERN PFNGLGENSAMPLERSPROC glGenSamplers;
__EXTERN PFNGLDELETESAMPLERSPROC glDeleteSamplers;
__EXTERN PFNGLBINDSAMPLERPROC glBindSampler;
__EXTERN PFNGLSAMPLERPARAMETERIPROC glSamplerParameteri;
__EXTERN PFNGLSAMPLERPARAMETERFPROC glSamplerParameterf;
__EXTERN PFNGLTEXIMAGE2DMULTISAMPLEPROC glTexImage2DMultisample;
__EXTERN PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC glRenderbufferStorageMultisample;
__EXTERN PFNGLBLITFRAMEBUFFERPROC glBlitFramebuffer;
__EXTERN PFNGLCHECKFRAMEBUFFERSTATUSPROC glCheckFramebufferStatus;
__EXTERN PFNGLVERTEXATTRIBIPOINTERPROC glVertexAttribIPointer;
